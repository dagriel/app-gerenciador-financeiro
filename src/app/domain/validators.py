...
Regras de validação que fazem parte do domínio (ex.: parsing/validação de mês),
compartilhadas por services, schemas e seeds.

Obs.: `app.core.validators` é mantido como compatibilidade, mas a implementação
“fonte” passa a ficar aqui.
"""
